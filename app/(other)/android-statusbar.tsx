...
export default function AndroidStatusBarNavigationBarScreen() {
    ...
    <DemoScreen>
      <View style={styles.container}>
        <Text style={styles.text}>
          This screen presents how to change status bar / navigation bar colors with
          UnistylesRuntime
        </Text>
        {Platform.OS !== 'android' && (
          <Text style={styles.bold}>Please open Android emulator to see the effect</Text>
        )}
        <Button
