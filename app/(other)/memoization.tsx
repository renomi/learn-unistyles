  ...
  return (
    <DemoScreen>
      <View style={styles.container}>
        <ScrollView>
          <Text>Unistyles respects React.memo</Text>
          <Memoized text="Static" style={styles.text} />
          <Memoized text="Breakpoints" style={styles.breakpoints} />
          <Memoized text="Media queries" style={styles.mediaQueries} />
          <Memoized text="Dynamic fn" style={styles.dynamicFunction()} />
          <Memoized text="Variants" style={styles.textVariants} />
...
const Memoized = memo<MemoizedProps>(({ text, style }) => (
  <Text style={style}>
    {text} ({useRenderCount()})
  </Text>
));
