...
export default function HighContrastPluginScreen() {
  ...
  const isHighContrastPluginEnabled = UnistylesRuntime.enabledPlugins.includes(
    highContrastPlugin.name
  );

  return (
    <DemoScreen>
      <View style={styles.container}>
        <Text style={styles.text}>This screen has a enabled High Contrast plugin</Text>
