...
export default function TwoThemesScreen() {
  ...
  return (
    <DemoScreen>
      <View style={styles.container}>
        ...
        <Text style={styles.text}>
          It also shows a way to switch the theme from anywhere of your app. You can do that
          importing `UnistylesRuntime` and calling `setTheme` function.
        </Text>
        <Text style={styles.text}>This screen uses {UnistylesRuntime.themeName} theme.</Text>
        <Button
          title="Switch theme"
