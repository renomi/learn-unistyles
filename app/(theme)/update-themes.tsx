...
export default function UpdateThemeScreen() {
  ...
  return (
    <DemoScreen>
      <View style={styles.container}>
        <Text style={styles.text}>This screen demonstrates how to update theme in runtime.</Text>
        <Text style={styles.text}>Current theme: {UnistylesRuntime.themeName}</Text>
        <Text style={styles.theme}>Colors: {JSON.stringify(theme.colors, null, 2)}</Text>
        <Text style={styles.text}>Number of re-renders: {renderCount.current++}</Text>
        <Button
          ...
          onPress={() => {
            ...
            UnistylesRuntime.updateTheme('light', (theme) => ({
              ...
              colors: {
                ...theme.colors,
                typography: theme.colors.typography === '#000000' ? theme.colors.blood : '#000000',
              },
            }));
          }}
        />
        <Button
          ...
          onPress={() => {
            ...
            UnistylesRuntime.updateTheme('dark', (theme) => ({
              ...
              colors: {
                ...theme.colors,
                typography: theme.colors.typography === '#ffffff' ? theme.colors.aloes : '#ffffff',
              },
            }));
          }}
        />
